...
export default function Section(){
  ...
  if(section==='contact')return <main><section className="pagehead"><div className="w"><div className="k">Dicey Shoes</div><h1>CONTACT</h1></div></section><section><div className="w prose"><p>For order, product or general support, message Dicey Enterprise on WhatsApp.</p><p><a href="https://wa.me/15485382258" target="_blank" rel="noreferrer">WhatsApp +1 548 538 2258 ↗</a></p></div></section></main>;
