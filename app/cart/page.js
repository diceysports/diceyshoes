...
export default function CartPage(){
  ...
  async function checkout(){
    ...
    try{
      const r=await fetch('/api/checkout',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({items:cart.map(x=>({slug:x.slug,size:x.size,sizing:x.sizing||''}))})});
