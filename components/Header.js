...
const primary=[
  ['/shop','Shop all shoes'],['/search','Find a shoe'],['/community','Community'],['/releases','New releases'],['/brands','Brands']
];
const shop=[['/men','Men'],['/women','Women'],['/luxury','Luxury'],['/wishlist','Wishlist'],['/cart','Bag']];
...
export default function Header(){
  ...
  return <>
    <div className="promo">DICEY SHOES · NEW DROPS · PRICES IN USD</div>
    <nav className="nav"><div className="w ni">
      ...
      <div className="links"><Link href="/shop">Shop</Link><Link href="/men">Men</Link><Link href="/women">Women</Link><Link href="/luxury">Luxury</Link><Link href="/releases">Releases</Link><Link href="/brands">Brands</Link><Link href="/news">News</Link></div>
